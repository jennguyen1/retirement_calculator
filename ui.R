    ...
    box(
      ...
      tabBox(width = NULL, selected = "Input Data",
        ...
        tabPanel("Instructions",
          ...
          p("This app is for informational purposes only. It should not be considered financial advice. You should consult with a professional to determine what may be the best for your individual needs.")
        ),
        ...
        tabPanel("Input Data",
          ...
          fluidRow(
            ...
            column(width = 6, numericInput("growth_rate", "Growth Rate", 0.05, min = 0, max = 0.2, step = 0.01))
          ),
          fluidRow(
