    ...
    box(
      ...
      tabBox(width = NULL, selected = "Input Data",
        ...
        tabPanel("Instructions",
          p("This is an shiny application that computes rough projections for retirement savings."),
        ...
        tabPanel("Input Data",
          fluidRow(
            ...
            column(width = 6, numericInput("retire_early", "Retire Age", 55, min = 30, max = 60))
          ),
          fluidRow(
          ...
          fluidRow(
            column(width = 6, numericInput("tax_starting_principle", "Initial Principle in Taxable Accounts", 0, min = 0)),
            column(width = 6, numericInput("nontax_starting_principle", "Initial Principle in Retirement Accounts", 11000, min = 0))
          ),
          fluidRow(
            column(width = 6, numericInput("tax_yearly_add", "Amount Added to Taxable Account Yearly", 18000, min = 0)),
            column(width = 6, numericInput("nontax_yearly_add", "Amount Added to Retirement Account Yearly", 36000, min = 0))
          )
        )
      )
